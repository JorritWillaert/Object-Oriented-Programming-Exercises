...
abstract class Shape {} //Extends automatically from Object

//Circle is a subclass of Shape
//Shape is a superclass of Circle
...
class Drawing {
	...
	String toText() {
		...
		for (int i = 0; i < shapes.length; i++) {
			Shape shape = shapes[i]; //Polymorphic variable
			if (shape instanceof Circle) {
				//First: static type checker (incomplete) --> So, typecast
				Circle circle = (Circle) shape; //ClassCastException if shape is not a circle here;
